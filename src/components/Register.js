  ...
  return(
    <div className='page'>
      ...
      <h1 className='start-form__title'>Регистрация</h1>
        <input onChange={handleEmailChange} value={email} type='email' name='email' className="start-form__input" placeholder='Email' />
        <input onChange={handlePasswordChange} value={password} type='password' name='password' className="start-form__input" placeholder='Пароль' />
